...
public class SellerAddNewProductActivity extends AppCompatActivity
{
    ...
    private String sName, sEmail, sID, sAddress, sPhone;
    ...
    private void checkAfterRequestForPerission() {
        ...
        if(ContextCompat.checkSelfPermission(SellerAddNewProductActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE)!= PackageManager.PERMISSION_GRANTED){
            if(ActivityCompat.shouldShowRequestPermissionRationale(SellerAddNewProductActivity.this,Manifest.permission.READ_EXTERNAL_STORAGE)){
                Toast.makeText(SellerAddNewProductActivity.this, "Please accept the required permission", Toast.LENGTH_SHORT).show();
            }
            else{
                ActivityCompat.requestPermissions(SellerAddNewProductActivity.this,new String[]{Manifest.permission.READ_EXTERNAL_STORAGE},PReqCode);
            }
        }
        else{
            openGallery();
